...
<p align="center">
  ☕ Hilft dir ImmoBase? Dann kannst du mir gern <a href="https://ko-fi.com/marcelgast">einen Kaffee auf Ko-fi ausgeben</a> — ganz ohne Gegenleistung, einfach als kleines Dankeschön.<br>
  <em>Finding ImmoBase useful? Feel free to <a href="https://ko-fi.com/marcelgast">buy me a coffee on Ko-fi</a> — no perks, no strings, just a small thank-you.</em>
</p>
...
```bash
git clone https://github.com/marcelgast/immobase.git
cd immobase
./install.sh
```
